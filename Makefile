...
# Template: subdirs
# Command: /usr/lib/qt5/bin/qmake -o Makefile ../multidisplay-app/multidisplay-app.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
DISTDIR = /home/rattrax/git/build-multidisplay-app-Desktop-Debug/.tmp/multidisplay-app1.0.0
SUBTARGETS    =  \
		sub-libs-qwt-6-1-1 \
		sub-src
...
sub-libs-qwt-6-1-1-qmake_all:  FORCE
	...
	cd libs/qwt-6.1.1/ && $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
	cd libs/qwt-6.1.1/ && $(MAKE) -f Makefile qmake_all
sub-libs-qwt-6-1-1: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile
...
sub-libs-qwt-6-1-1-all-ordered: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-libs-qwt-6-1-1-all: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-libs-qwt-6-1-1-clean-ordered: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-libs-qwt-6-1-1-clean: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-libs-qwt-6-1-1-distclean-ordered: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-libs-qwt-6-1-1-distclean: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-libs-qwt-6-1-1-install_subtargets-ordered: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile install
sub-libs-qwt-6-1-1-install_subtargets: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile install
sub-libs-qwt-6-1-1-uninstall_subtargets-ordered: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile uninstall
sub-libs-qwt-6-1-1-uninstall_subtargets: FORCE
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile uninstall
sub-src-qmake_all: sub-libs-qwt-6-1-1-qmake_all FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
	cd src/ && $(MAKE) -f Makefile qmake_all
sub-src: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile
...
sub-src-all-ordered: sub-libs-qwt-6-1-1-all-ordered  FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-src-all: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-src-clean-ordered: sub-libs-qwt-6-1-1-clean-ordered  FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-src-clean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-src-distclean-ordered: sub-libs-qwt-6-1-1-distclean-ordered  FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-src-distclean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-src-install_subtargets-ordered: sub-libs-qwt-6-1-1-install_subtargets-ordered  FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile install
...
sub-src-uninstall_subtargets-ordered: sub-libs-qwt-6-1-1-uninstall_subtargets-ordered  FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile uninstall
...
Makefile: ../multidisplay-app/multidisplay-app.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/modules/qt_lib_texttospeech.pri \
		...
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/modules/qt_lib_waylandclient.pri \
		...
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/modules/qt_lib_webview.pri \
	...
	$(QMAKE) -o Makefile ../multidisplay-app/multidisplay-app.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
sub-libs-qwt-6-1-1-check_ordered:
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile check
sub-src-check_ordered: sub-libs-qwt-6-1-1-check_ordered 
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile check
check: sub-libs-qwt-6-1-1-check_ordered sub-src-check_ordered

sub-libs-qwt-6-1-1-benchmark_ordered:
	@test -d libs/qwt-6.1.1/ || mkdir -p libs/qwt-6.1.1/
	cd libs/qwt-6.1.1/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/libs/qwt-6.1.1/qwt-6.1.1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile benchmark
sub-src-benchmark_ordered: sub-libs-qwt-6-1-1-benchmark_ordered 
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/rattrax/git/multidisplay-app/src/src.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile benchmark
